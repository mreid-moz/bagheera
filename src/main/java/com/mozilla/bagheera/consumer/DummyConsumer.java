...
import com.mozilla.bagheera.sink.DummySink;
...
/**
 * Kafka consumer which reads from a kafka queue and discards everything it sees.
 */
public final class DummyConsumer extends App {

    private static final Logger LOG = Logger.getLogger(DummyConsumer.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            KeyValueSinkFactory sinkFactory = KeyValueSinkFactory.getInstance(DummySink.class, sinkConfig);
...
//            final MetricsManager manager = MetricsManager.getDefaultMetricsManager();
            ...
            formatter.printHelp(DummyConsumer.class.getName(), options);
        }
    }
}
